...
header_directories(${SDK_ROOT}/src/${PROJ}/lib/libjpeg/include)
header_directories(${SDK_ROOT}/src/${PROJ}/lib/libgd/include)
target_link_libraries(${PROJ}  ${SDK_ROOT}/src/${PROJ}/lib/libgd/libgd.a)
target_link_libraries(${PROJ}  ${SDK_ROOT}/src/${PROJ}/lib/libjpeg/libjpeg.a)
